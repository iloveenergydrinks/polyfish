...
def retry_with_backoff(
    ...
    Args:
        ...
        on_retry: Callback invoked on retry, with (exception, retry_count)
...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        """
        Execute a batch of calls and retry each failed item individually.
        
        Args:
            items: List of items to process
            process_func: Processing function that receives a single item
            exceptions: Exception types that should trigger a retry
