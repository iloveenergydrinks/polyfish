...
def generate_report ():
    ...
    try :
        ...
        if not graph_id :
            return jsonify ({
            "success":False ,
            "error":"Map ID is missing, please make sure you have built the map"
            }),400 
        ...
        "task_id":task_id ,
        "status":"generating",
        "message":"The report generation task has been started, please check the progress through /api/report/generate/status",
...
def get_report_by_simulation (simulation_id :str ):
    ...
    try :
        ...
        if not report :
            return jsonify ({
            "success":False ,
            "error":f"There are currently no reports for this simulation:{simulation_id }",
            "has_report":False 
            }),404 
