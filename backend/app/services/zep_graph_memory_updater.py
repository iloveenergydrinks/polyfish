...
class AgentActivity :
    ...
    def _describe_dislike_post (self )->str :
        ...
        if post_content and post_author :
            ...
            return f"Disliked a post from {post_author}"
    ...
    def _describe_dislike_comment (self )->str :
        ...
        if comment_content and comment_author :
            ...
            return f"Disliked a comment from {comment_author}"
...
class ZepGraphMemoryUpdater :
    ...
    def add_activity (self ,activity :AgentActivity ):
        ...
        logger .debug (f"Add an activity to the Zep queue:{activity .agent_name } - {activity .action_type }")
        ...
        for attempt in range (self .MAX_RETRIES ):
            try :
                ...
                if attempt <self .MAX_RETRIES -1 :
                    logger .warning (f"Bulk sending to Zep failed (try{attempt +1 }/{self .MAX_RETRIES }): {e }")
...
class ZepGraphMemoryManager :
    ...
    def create_updater (cls ,simulation_id :str ,graph_id :str )->ZepGraphMemoryUpdater :
        ...
        # If it already exists, stop the old one first
            ...
            logger .info (f"Create map memory updater: simulation_id={simulation_id }, graph_id={graph_id }")
            return updater 
    ...
    def stop_updater (cls ,simulation_id :str ):
        ...
        with cls ._lock :
            if simulation_id in cls ._updaters :
                ...
                logger .info (f"Stopped map memory updater: simulation_id={simulation_id }")
