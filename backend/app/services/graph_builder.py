...
Task ID
    ...
    batch_size :int 
        ...
        try :
            ...
            progress =5 ,
            message ="Start building the graph..."
            )
    ...
    def set_ontology (self ,graph_id :str ,ontology :Dict [str ,Any ]):
        ...
        # This is required usage by the Zep SDK, the warning comes from dynamic class creation and can be safely ignored
        ...
        for entity_def in ontology .get ("entity_types",[]):
            ...
            for attr_def in entity_def .get ("attributes",[]):
                ...
                # The Zep API requires a description of the Field, which is required
    ...
    timeout :int =600 
        ...
        while pending_episodes :
            if time .time ()-start_time >timeout :
                if progress_callback :
                    progress_callback (
                    f"Partial text block timed out and completed{completed_count }/{total_episodes }",
            ...
            if progress_callback :
                progress_callback (
                f"Zep is processing...{completed_count }/{total_episodes }Finish,{len (pending_episodes )}Pending ({elapsed }Second)",
