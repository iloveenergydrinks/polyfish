...
class SimulationState :
    ...
    def to_dict (self )->Dict [str ,Any ]:
        """Full status dictionary (used internally)"""
        return {
    ...
    def to_simple_dict (self )->Dict [str ,Any ]:
        """Simplified status dictionary (used by API returns)"""
        return {
        "simulation_id":self .simulation_id ,
        "project_id":self .project_id ,
        "graph_id":self .graph_id ,
...
class SimulationManager :
    ...
    parallel_profile_count :int =3 
        ...
        try :
            ...
            # ========== Phase 1: Reading and filtering entities ==========
            if progress_callback :
                progress_callback ("reading",0 ,"Connecting to Zep map...")
            ...
            if filtered .filtered_count ==0 :
                ...
                state .error ="No matching entities were found, please check whether the graph is constructed correctly."
                self ._save_simulation_state (state )
                return state 
            ...
            if progress_callback :
                ...
                # NOTE: The run script remains in the backend/scripts/ directory and is no longer copied to the simulation directory
            ...
            logger .info (f"Simulation preparation is complete:{simulation_id }, "
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        """Get instructions for running the simulation scripts manually."""
        sim_dir = self._get_simulation_dir(simulation_id)
        config_path = os.path.join(sim_dir, "simulation_config.json")
        ...
        return {
            ...
            "instructions": (
                "1. Activate the conda environment: `conda activate PolyFish`\n"
                f"2. Run the simulation scripts from `{scripts_dir}`:\n"
