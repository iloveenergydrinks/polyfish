...
class OntologyGenerator :
    ...
    additional_context :Optional [str ]=None 
        ...
        # Maximum length of text passed to LLM (50,000 words)
    ...
    additional_context :Optional [str ]
        ...
        if len (combined_text )>self .MAX_TEXT_LENGTH_FOR_LLM :
            ...
            combined_text +=f"\n\n...(Original text total{original_length }words, before interception{self .MAX_TEXT_LENGTH_FOR_LLM }Words used for ontology analysis)..."

        message =f"""## Simulation requirements{simulation_requirement }## Document content{combined_text }
"""

        if additional_context :
            message +=f"""## Additional instructions{additional_context }
"""

        message +="""Please design entity types and relationship types suitable for social public opinion simulation based on the above content.
...
5. Attribute names cannot use reserved words such as name, uuid, group_id, etc., use full_name, org_name, etc. instead"""
    ...
    def _validate_and_process (self ,result :Dict [str ,Any ])->Dict [str ,Any ]:
        ...
        if fallbacks_to_add :
            ...
            # Ultimately ensuring limits are not exceeded (defensive programming)
    ...
    def generate_python_code (self ,ontology :Dict [str ,Any ])->str :
        ...
        'Automatically generated by PolyFish for market narrative simulation',
        '"""',
        '',
