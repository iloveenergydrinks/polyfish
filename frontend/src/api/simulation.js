...
/**
 * Fetch agent profiles while they are still being generated
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Fetch the simulation configuration while it is still being generated
 * @param {string} simulationId
 * @returns {Promise} Configuration data including metadata and content
 */
...
/**
 * Fetch posts created inside the simulation
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
