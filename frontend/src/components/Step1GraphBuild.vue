    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/markets/project</p>
          <p class="description">
            The LLM analyzes live Polymarket metadata and the simulation requirement to generate an ontology that fits the market narrative and participant evolution.
          </p>

          <!-- Loading / Progress -->
          <div v-if="currentPhase === 0 && ontologyProgress" class="progress-section">
            <div class="spinner-sm"></div>
            <span>{{ ontologyProgress.message || 'Analyzing market metadata...' }}</span>
          </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using the generated ontology, the system chunks market descriptions, resolution conditions, price states, and event context, then calls Zep to build the knowledge graph, extract entities and relations, and form temporal memory plus community summaries.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph construction is complete. Continue to the next step to set up the simulation environment.</p>
          <button 
            class="action-btn" 
...
// Enter environment setup by creating the simulation and navigating there
...
.badge.success { background: #1a1a1a; color: #d4d4d4; }
.badge.processing { background: #888888; color: #111111; }
.badge.accent { background: #888888; color: #111111; }
.badge.pending { background: #1a1a1a; color: #666666; }
