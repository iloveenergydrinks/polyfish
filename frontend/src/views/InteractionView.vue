<template>
  <div class="main-view">
    ...
    <main class="content-area">
      ...
      <!-- Right Panel: Step 5 Interactive Analysis -->
...
const loadReportData = async () => {
  try {
    ...
    // Fetch report details so we can read simulation_id
    ...
    if (reportRes.success && reportRes.data) {
      ...
      addLog(`Failed to fetch report details: ${reportRes.error || 'Unknown error'}`)
    }
  } catch (err) {
...
.status-indicator.ready .dot { background: #d4d4d4; }
